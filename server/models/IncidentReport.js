...
const timelineEventSchema = new mongoose.Schema(
  { label: { type: String, required: true }, timestamp: { type: Date, required: true } },
  { _id: false }
);
...
const incidentReportSchema = new mongoose.Schema(
  {
    ...
    relatedLogId: { type: mongoose.Schema.Types.ObjectId, ref: "UploadedLog", required: true },
    ...
    recommendedMitigations: { type: [String], default: [] },
